...
name: baoyu-design
description: >-
  Create polished self-contained HTML design artifacts: UI mockups, interactive
  prototypes, wireframes, landing pages, dashboards, app screens, mobile apps, slide
  decks, and reusable design systems or UI kits. Use when the user asks to design,
  mock up, prototype, wireframe, visualize an interface or flow, create a pitch deck,
  build a landing page, set up or import a design system, author brand tokens, or
  compile a loadable component bundle. Runs across Claude Code, Cursor, Codex Agent,
  and comparable file-capable harnesses with tool references under references/.
---
