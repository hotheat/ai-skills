---
name: drawio-skill
description: Generate draw.io diagrams from natural language or codebase structure, including flowcharts, architecture diagrams, ERD, UML, sequence, class diagrams, network topology, ML/DL model figures, mind maps, and exportable PNG/SVG/PDF/JPG outputs via draw.io desktop CLI.
license: MIT
metadata:
  source: https://github.com/Agents365-ai/drawio-skill
  source-path: skills/drawio-skill
  source-commit: 00ed825c4aec623a5838a16d1ad6b7a2c603dfa6
  version: "1.14.0"
  compatibility: Requires draw.io desktop app CLI on PATH. Optional auto-layout needs Graphviz.
