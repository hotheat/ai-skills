...
description: Grilling session that challenges your plan against the existing domain model, sharpens terminology, and updates documentation such as CONTEXT.md and ADRs inline as decisions crystallise. Use when the user wants to stress-test a plan against project language, documented decisions, domain glossary, architecture records, CONTEXT.md, or docs/adr.
---
